 ...
 *
 * iOS implementation using native iOS tab styling and interactions
 */
...
import { StyledContainer, StyledContent, StyledTabBarContainer } from './SettingsScreen.ios.styles';
import useSettingsScreen from './useSettingsScreen';

/**
 * SettingsScreen iOS Component
 */
              ...
              {tabItems.map(tab => (
                <View
                  ...
                  style={{
                    ...
                    borderBottomColor: getCurrentTabId === tab.id ? '#0066cc' : '#ccc',
                  }}
                  testID={tab.testID}
                >
                  <Text
