/**
 * AssessmentEntryScreen Component - Web
 * File: AssessmentEntryScreen.web.jsx
 */
...
import {
  ...
  StyledContainer,
  StyledContent,
} from './AssessmentEntryScreen.web.styles';
...
const AssessmentEntryScreenWeb = () => {
  ...
  return (
    <StyledContainer aria-label={t('assessment.entry.title')} testID="assessment-entry-screen">
      <StyledContent>
...
export default AssessmentEntryScreenWeb;
