/**
 * VerifyPhoneScreen Component - iOS
 * Phone verification screen for iOS platform
 * File: VerifyPhoneScreen.ios.jsx
 */
import React from 'react';
import { AuthFormLayout, Button, ErrorState, OfflineState, Stack, Text, TextField } from '@platform/components';
import { useI18n } from '@hooks';
import { StyledActions, StyledForm, StyledLinkRow } from './VerifyPhoneScreen.ios.styles';
import useVerifyPhoneScreen from './useVerifyPhoneScreen';

/**
 * VerifyPhoneScreen component for iOS
 */
