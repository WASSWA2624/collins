/**
 * ForgotPasswordScreen Component - iOS
 * Password recovery screen for iOS platform
 * File: ForgotPasswordScreen.ios.jsx
 */
import React from 'react';
import { AuthFormLayout, Button, ErrorState, OfflineState, Stack, Text, TextField } from '@platform/components';
import { useI18n } from '@hooks';
import { StyledActions, StyledForm, StyledLinkRow } from './ForgotPasswordScreen.ios.styles';
import useForgotPasswordScreen from './useForgotPasswordScreen';

/**
 * ForgotPasswordScreen component for iOS
 */
