/**
 * ForgotPasswordScreen Component - Android
 * Password recovery screen for Android platform
 * File: ForgotPasswordScreen.android.jsx
 */
import React from 'react';
import { AuthFormLayout, Button, ErrorState, OfflineState, Stack, Text, TextField } from '@platform/components';
import { useI18n } from '@hooks';
import { StyledActions, StyledForm, StyledLinkRow } from './ForgotPasswordScreen.android.styles';
import useForgotPasswordScreen from './useForgotPasswordScreen';

/**
 * ForgotPasswordScreen component for Android
 */
