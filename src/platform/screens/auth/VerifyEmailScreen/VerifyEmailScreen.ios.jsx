/**
 * VerifyEmailScreen Component - iOS
 * Email verification screen for iOS platform
 * File: VerifyEmailScreen.ios.jsx
 */
import React from 'react';
import { AuthFormLayout, Button, ErrorState, OfflineState, Stack, Text, TextField } from '@platform/components';
import { useI18n } from '@hooks';
import { StyledActions, StyledForm, StyledLinkRow } from './VerifyEmailScreen.ios.styles';
import useVerifyEmailScreen from './useVerifyEmailScreen';

/**
 * VerifyEmailScreen component for iOS
 */
