/**
 * VerifyEmailScreen Component - Web
 * Email verification screen for Web platform
 * File: VerifyEmailScreen.web.jsx
 */
import React from 'react';
import { AuthFormLayout, Button, ErrorState, OfflineState, Stack, Text, TextField } from '@platform/components';
import { useI18n } from '@hooks';
import { StyledActions, StyledForm, StyledLinkRow } from './VerifyEmailScreen.web.styles';
import useVerifyEmailScreen from './useVerifyEmailScreen';

/**
 * VerifyEmailScreen component for Web
 */
