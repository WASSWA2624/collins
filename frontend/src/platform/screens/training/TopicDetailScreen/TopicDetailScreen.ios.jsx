/**
 * TopicDetailScreen Component - iOS
 * File: TopicDetailScreen.ios.jsx
 */
...
import {
  ...
  StyledChecklistItem,
} from './TopicDetailScreen.ios.styles';
import { TOPIC_DETAIL_TEST_IDS } from './types';

const TopicDetailScreenIos = ({ topicId }) => {
  const { t } = useI18n();
...
export default TopicDetailScreenIos;
