...
import {
  ...
  StyledHeaderTitle,
  StyledContent,
} from './DisclaimerLayout.ios.styles';

const DisclaimerLayoutIOS = ({ children, accessibilityLabel, testID }) => {
  const { t } = useI18n();
...
export default DisclaimerLayoutIOS;
