...
import { newPatientsRouter } from '../modules/newPatients/newPatients.routes.js';
...
apiRouter.use('/new-patients', newPatientsRouter);
apiRouter.use('/admissions', newPatientsRouter);
