...
facilitiesRouter.get('/:id', requireAuth, validateRequest(facilityIdSchema), getFacility);
facilitiesRouter.post('/:id/request-verification', requireAuth, validateRequest(facilityIdSchema), requestVerification);
facilitiesRouter.get('/:id/equipment-profile', requireAuth, validateRequest(facilityIdSchema), getEquipmentProfile);
